...
<div class="takeaway">학습 없이 치수와 모양만으로 판별</div>
""",
...
{figure('15_pallet_choice.png', '포크를 넣은 채로 EPAL 6과 T11 곱하기 0.6을 나란히 비교', '포크를 넣은 상태 · MuJoCo')}
...
{figure('22_points_lost.png', '같은 촬영 장면의 측정점을 옆에서 본 모습. 왼쪽은 바닥판 점이 사라지고 오른쪽은 남는다', '옆에서 본 측정점 · 회색은 버려진 점')}
...
{figure('04_frozen_vs_derived.mp4', '같은 주행을 종전 고정값과 규격 기반 산출값으로 나란히 재생', '같은 주행 183장 · 좌 종전 0장, 우 계산값 150장 검출 · 측정 리그')}
<div class="rule body">바닥 제거 <b>20 → 7.3 mm</b> · 면 두께 <b>20 → 7.8 mm</b> · 최소 측정점 <b>100 → 15</b></div>
...
<div class="roadmap grow"><article class="done"><h3>M1 · M2</h3><p>포켓 인식</p><p class="state">완료</p></article><article class="now"><h3>M3</h3><p>포켓 추적</p><p class="state">다음 주</p></article><article class="wait"><h3>차체 입고</h3><p>실측 · 제작 · 재측정</p><p class="state">대기</p></article><article class="wait"><h3>M4 ~ M6</h3><p>지도 · 주행 · 삽입 · 이송</p><p class="state">이후</p></article></div>
