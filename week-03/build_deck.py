...
# ----------------------------------------------------------------- 7
add('기준값 산출 방식', '05  기준값 산출 방식', 46, f"""
<h2 class="headline">규격이 다른 팔레트에 대한 검출 기준 일반화</h2>
...
<h2 class="headline">카메라 설치 높이에 따른 근거리 검출 성능 차이</h2>
{figure('13_camera_mount.png', '카메라 높이 0.27, 0.50, 0.90 m에서 같은 거리에 둔 팔레트와 각 높이의 수직 관측 범위', '적색 점이 카메라 위치')}
<div class="takeaway">합성 비교: 카메라 높이 0.27 / 0.50 / 0.90 m 에서 검출 22 / 20 / 4 | 실제 설치 높이 미확정</div>
""",
