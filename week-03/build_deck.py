...
{figure('04_frozen_vs_derived.mp4', '촬영한 같은 주행을 두 설정으로 나란히 재생. 왼쪽은 버리는 띠가 두꺼워 끝까지 못 찾는다', '촬영한 같은 주행 101장 · 좌 0장, 우 97장 검출 · 색 띠가 버리는 구간')}
<div class="rule body">바닥 제거 <b>20 → 7.3 mm</b> · 면 두께 <b>20 → 7.8 mm</b> · 팔레트로 인정할 최소 측정점 <b>100 → 15</b><br>팔레트가 작아지면 같은 부위에서 나오는 측정점도 줄어들므로 기준 개수도 함께 줄인다</div>
