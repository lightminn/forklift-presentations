...
<p class="small muted">검출기는 포켓으로 판정하기 전에 아랫판이 실제로 보이는지 확인한다</p>
...
<div class="swap"><div><b>아랫판 증거 문턱</b><span>100개 <i>→</i> 15개</span></div><div><b>같은 면으로 묶는 두께</b><span>20 mm <i>→</i> 7.8 mm</span></div><div><b>바닥에서 제외하는 높이</b><span>20 mm <i>→</i> 7.3 mm</span></div></div>
