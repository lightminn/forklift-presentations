...
<div class="roadmap grow"><article class="now"><h3>차체 파라미터 실측</h3><p>치수·무게·축간 거리<br>포크 치수·승강 범위<br>최소 회전 반경</p><p class="state">다음 주</p></article><article class="now"><h3>제어 회로 분석</h3><p>배선·제어기 신호 형식<br>모터 정격·구동 방식<br>속도·조향각·포크 높이 신호</p><p class="state">다음 주</p></article><article class="wait"><h3>자율주행용 개조</h3><p>컴퓨터 명령 입력 경로<br>주행·조향·승강 상태 피드백<br>전원·배선 정리</p><p class="state">회로 분석 후</p></article><article class="wait"><h3>센서 부착</h3><p>RGB-D 카메라 장착점·브래킷<br>2D LiDAR 장착 위치·높이<br>센서 좌표 변환 보정</p><p class="state">실측 후</p></article></div>
