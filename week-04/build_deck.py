...
<rect x="518" y="364" width="16" height="10" rx="2" fill="#1d7a3a"/><polygon points="534,369 590,364 590,374" fill="#1d7a3a" opacity="0.45"/>
</g>
<line x1="466" y1="383" x2="516" y2="370" stroke="#1d7a3a" stroke-width="2"/>
...
<circle cx="452" cy="386" r="16" fill="#d9822b"/><text x="452" y="393">④</text>
</g>
...
<tr><td><span class="mk">①</span></td><td>ifm PDS</td><td>바닥 위 23~36 cm<br>정면 수직</td><td>ToF 카메라로<br>팔레트 인식</td></tr>
<tr><td><span class="mk">②</span></td><td>Crown 특허</td><td>포크 캐리지 하단<br>포크와 함께 승강·좌우 이동</td><td>ToF 카메라<br>포크 끝이 화면 아래쪽</td></tr>
<tr><td><span class="mk">③</span></td><td>Toyota·AIST</td><td>백레스트</td><td>어안 카메라<br>포크와 함께 이동</td></tr>
<tr><td><span class="mk">④</span></td><td>ADAPT</td><td>스테레오 카메라<br>+ 포크 높이 2D LiDAR</td><td>멀리서는 카메라<br>마지막 접근은 LiDAR</td></tr></table>"""
...
<h2 class="headline">실제 지게차의 팔레트 인식 센서 장착 위치</h2>
...
""",
    """3주차에 실제 지게차는 카메라를 어디에 다는지 확인하고 우리 차체에 맞추어 보라는 지적을 받았다. 그림은 지게차 옆모습에 사례별 위치를 표시한 것이다. 첫째, ifm의 PDS는 빛이 돌아오는 시간으로 거리를 재는 ToF 카메라로 팔레트를 인식하며, 바닥에서 23에서 36센티미터 높이에 정면을 수직으로 보도록 단다. 둘째, 지게차 제조사 Crown의 특허는 ToF 카메라를 포크 캐리지 하단에 달아 포크와 함께 오르내리고 좌우로 움직이게 하며, 포크 끝이 화면 아래쪽에 보이게 해 다가오는 팔레트를 일찍 본다. 셋째, 도요타와 일본 산업기술종합연구소의 자율 지게차는 포크 뒤 백레스트에 어안 카메라를 달아 포크와 함께 움직이게 했다. 넷째, 자율 지게차 연구 ADAPT는 멀리서는 스테레오 카메라로 팔레트를 찾고, 마지막 접근은 포크 높이에 단 2D LiDAR로 정밀하게 맞춘다. 공통점은 포켓 높이 가까이, 포크와 함께 움직이는 자리에 단다는 것이다.""",
